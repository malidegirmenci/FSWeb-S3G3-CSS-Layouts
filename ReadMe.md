...
- [X] Web sayfalarınızı değişik tarayıcı genişliklerine(width) göre yapın (mobil sayfası dahil)
- [x] CSS animasyonları ekleyin
- [ ] Şu sayfalar için kendi çerçevelerinizi oluşturun ve çalıştırın `Hakkında`, `Projeler`, ve `İletişim` 
